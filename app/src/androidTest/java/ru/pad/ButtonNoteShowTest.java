...
public class ButtonNoteShowTest {
    ...
    @Test
    public void buttonNoteShowTest() {
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.buttonActivityName), withText("������� 19:47:25"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.cardview.widget.CardView")),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewMood), withText("����������: 0/10"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.ScrollView.class))),
                        isDisplayed()));
        textView.check(matches(withText("����������: 0/10")));
    }
