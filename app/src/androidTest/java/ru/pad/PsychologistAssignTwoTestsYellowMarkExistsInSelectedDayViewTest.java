...
public class PsychologistAssignTwoTestsYellowMarkExistsInSelectedDayViewTest {
    ...
    @Test
    public void psychologistAssignTwoTestsYellowMarkExistsInSelectedDayViewTest() {
        ...
        ViewInteraction recyclerView2 = onView(
                allOf(withId(R.id.recyclerViewAssigningTests),
                        childAtPosition(
