...
public class PsychologistDeclineRequestSportsmanDeclineMessageTest {
    ...
    @Test
    public void psychologistDeclineRequestSportsmanDeclineMessageTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewAddPsychologistStatus), withText("���� ������ ���������"),
