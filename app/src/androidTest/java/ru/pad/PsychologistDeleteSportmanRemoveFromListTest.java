...
public class PsychologistDeleteSportmanRemoveFromListTest {
    ...
    @Test
    public void psychologistDeleteSportmanRemoveFromListTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewNoSportsmen), withText("� ��� ���� ��� �����������"),
