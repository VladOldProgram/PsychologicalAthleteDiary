...
public class SportsmanCompleteTestYellowMarkNotExistsGreenMarkExistsInCalendarTest {
    ...
    @Test
    public void sportsmanCompleteTestYellowMarkNotExistsGreenMarkExistsInCalendarTest() {
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.buttonActivityName), withText("�������������� ���� ������, ��� 21:39:13"),
                        childAtPosition(
                                childAtPosition(
