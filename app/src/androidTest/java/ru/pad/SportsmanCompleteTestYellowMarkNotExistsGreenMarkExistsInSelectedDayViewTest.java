...
public class SportsmanCompleteTestYellowMarkNotExistsGreenMarkExistsInSelectedDayViewTest {
    ...
    @Test
    public void sportsmanCompleteTestYellowMarkNotExistsGreenMarkExistsTest() {
