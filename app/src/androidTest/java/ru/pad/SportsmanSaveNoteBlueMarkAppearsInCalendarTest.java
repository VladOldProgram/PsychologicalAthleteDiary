...
public class SportsmanSaveNoteBlueMarkAppearsInCalendarTest {
    ...
    @Test
    public void sportsmanSaveNoteBlueMarkAppearsInCalendarTest() {
        ...
        ViewInteraction imageView = onView(
                allOf(withId(R.id.imageViewNoteMark), withContentDescription("Note mark"),
