...
public class SportsmanSaveNoteBlueMarkAppearsInSelectedDayViewTest {
    ...
    @Test
    public void sportsmanSaveNoteBlueMarkAppearsInSelectedDayViewTest() {
        ...
        ViewInteraction bottomNavigationItemView = onView(
                allOf(withId(R.id.notes), withContentDescription("�������"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editTextSituation),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.buttonSaveNote), withText("���������"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.ScrollView")),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textViewNotes), withText("�������"),
                        withParent(allOf(withId(R.id.linearLayoutNotes),
