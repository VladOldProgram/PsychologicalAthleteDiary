...
public class CalendarViewActivity extends AppCompatActivity implements CalendarAdapter.OnItemListener {
    ...
    protected void initWidgets() {
        ...
        buttonCloseLegend.setOnClickListener(unused1 -> calendarLegend.dismiss());
        calendarLegend.setCancelable(false);

        Button buttonShowLegend = findViewById(R.id.buttonShowLegend);
        buttonShowLegend.setOnClickListener(unused2 -> calendarLegend.show());
        ...
        buttonPreviousMonth.setOnClickListener(unused3 -> previousMonthAction());
        Button buttonNextMonth = findViewById(R.id.buttonNextMonth);
        buttonNextMonth.setOnClickListener(unused4 -> nextMonthAction());
                ...
                activity.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(
                                ...
                                "Произошла ошибка при получении меток дней календаря (" + error.getMessage() + ")",
                                Toast.LENGTH_LONG
                        ).show();
                    }
                });
     ...
     */
    public ArrayList<String> getDaysOfMonthArray(LocalDate date) {
     ...
     */
    public String getMonthYearFromDate(LocalDate date) {
