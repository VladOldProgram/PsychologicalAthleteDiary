...
public class RequestsActivity extends AppCompatActivity {
    ...
    /**
     * Отображает эту активность на экране, вызывает метод <b>getRequestsData()</b>
     ...
     */
    protected void getRequestsData() {
        /*
        ...
        dbUsers.child(psychologistUid).addValueEventListener(new ValueEventListener() {
                        ...
                        dbUsers.child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onCancelled(@NonNull DatabaseError error) {
                                Toast.makeText(
                                        ...
                                        "Произошла ошибка получении данных спортсмена " + key + " (" + error.getMessage() + ")",
                                        Toast.LENGTH_LONG
                                ).show();
                            }
                        });
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(
                        RequestsActivity.this,
                        "Произошла ошибка при получении списка заявок (" + error.getMessage() + ")",
                        Toast.LENGTH_LONG
                ).show();
            }
        });
