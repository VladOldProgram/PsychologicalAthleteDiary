...
public class TestViewActivity extends AppCompatActivity {
                ...
                if (url.contains("/result?v=")
                    ...
                    dbUser
                            ...
                            .addOnFailureListener(e -> {
                                Toast.makeText(
                                        TestViewActivity.this,
                                        "Произошла ошибка при сохранении результата теста (" + e.getMessage() + ")",
                                        Toast.LENGTH_LONG
                                ).show();
                            });
                    /*
     ...
     */
    @SuppressWarnings("deprecation")
    public static class getCleanedHTMLPageTask extends AsyncTask<String, String, Document> {
